...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        newtoptags = [[tag.name,sum([a._get_ranking(tag) for a in Entry.objects.all()])] for tag in Tag.objects.all()]
        ...
        newtoptags_d1 = [[tag.name,sum([ a._get_ranking(tag,'decay1') for a in Entry.objects.all()])] for tag in Tag.objects.all()]
        ...
        newtoptags_d2 = [[tag.name,sum([ a._get_ranking(tag,'decay2') for a in Entry.objects.all()])] for tag in Tag.objects.all()]
        ...
        newtoptags_d3 = [[tag.name,sum([ a._get_ranking(tag,'decay3') for a in Entry.objects.all()])] for tag in Tag.objects.all()]
        ...
        newtoptags_d4 = [[tag.name,sum([ a._get_ranking(tag,'decay4') for a in Entry.objects.all()])] for tag in Tag.objects.all()]
        ...
        newtoptags_d6 = [[tag.name,sum([ a._get_ranking(tag,'decay6') for a in Entry.objects.all()])] for tag in Tag.objects.all()]
        ...
        newtoptags_d7 = [[tag.name,sum([ a._get_ranking(tag,'decay7') for a in Entry.objects.all()])] for tag in Tag.objects.all()]
        ...
        newtoptags_d8 = [[tag.name,sum([ a._get_ranking(tag,'decay8') for a in Entry.objects.all()])] for tag in Tag.objects.all()]
