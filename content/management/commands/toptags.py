...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        newtoptags_d1 = sorted([[tag.name,sum([ a.decayed_score_1.tagval_set.get(tag__iexact=tag).val for tag in taglist])] for tag in Tag.objects.all()], key=lambda a: -a[1])
        newtoptags_d2 = sorted([[tag.name,sum([ a.decayed_score_2.tagval_set.get(tag__iexact=tag).val for tag in taglist])] for tag in Tag.objects.all()], key=lambda a: -a[1])
        newtoptags_d3 = sorted([[tag.name,sum([ a.decayed_score_3.tagval_set.get(tag__iexact=tag).val for tag in taglist])] for tag in Tag.objects.all()], key=lambda a: -a[1])
        newtoptags_d4 = sorted([[tag.name,sum([ a.decayed_score_4.tagval_set.get(tag__iexact=tag).val for tag in taglist])] for tag in Tag.objects.all()], key=lambda a: -a[1])
        newtoptags_d5 = sorted([[tag.name,sum([ a.decayed_score_5.tagval_set.get(tag__iexact=tag).val for tag in taglist])] for tag in Tag.objects.all()], key=lambda a: -a[1])
        newtoptags_d6 = sorted([[tag.name,sum([ a.decayed_score_6.tagval_set.get(tag__iexact=tag).val for tag in taglist])] for tag in Tag.objects.all()], key=lambda a: -a[1])
        newtoptags_d7 = sorted([[tag.name,sum([ a.decayed_score_7.tagval_set.get(tag__iexact=tag).val for tag in taglist])] for tag in Tag.objects.all()], key=lambda a: -a[1])
        newtoptags_d8 = sorted([[tag.name,sum([ a.decayed_score_8.tagval_set.get(tag__iexact=tag).val for tag in taglist])] for tag in Tag.objects.all()], key=lambda a: -a[1])
