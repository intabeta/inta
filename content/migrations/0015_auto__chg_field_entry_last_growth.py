...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.last_growth'
        db.alter_column('content_entry', 'last_growth', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Entry.last_growth'
        db.alter_column('content_entry', 'last_growth', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))
