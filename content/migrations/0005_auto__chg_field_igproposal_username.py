...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IgProposal.username'
        db.alter_column('content_igproposal', 'username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'IgProposal.username'
        db.alter_column('content_igproposal', 'username', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
