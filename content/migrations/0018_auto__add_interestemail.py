...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InterestEmail'
        db.create_table('content_interestemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=1000)),
        ))
        db.send_create_signal('content', ['InterestEmail'])


    def backwards(self, orm):
        # Deleting model 'InterestEmail'
        db.delete_table('content_interestemail')
    ...
    models = {
        ...
        'content.entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ig': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['content.InterestGroup']"}),
            'last_growth': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '12', 'decimal_places': '6'}),
            'last_score': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'photo': ('django.db.models.fields.URLField', [], {'max_length': '1000', 'blank': 'True'}),
            ...
            'voted_by': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'voters'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        'content.igproposal': {
            'Meta': {'ordering': "['date_submitted']", 'object_name': 'IgProposal'},
        ...
        'content.interestemail': {
            'Meta': {'object_name': 'InterestEmail'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '1000'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'content.logo': {
            ...
            'site': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
        },
