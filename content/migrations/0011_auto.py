...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('content_entry_voted_by', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['content.entry'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('content_entry_voted_by', ['entry_id', 'user_id'])

        # Adding M2M table for field double_voted_by on 'Entry'
        db.create_table('content_entry_double_voted_by', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['content.entry'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('content_entry_double_voted_by', ['entry_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field voted_by on 'Entry'
        db.delete_table('content_entry_voted_by')

        # Removing M2M table for field double_voted_by on 'Entry'
        db.delete_table('content_entry_double_voted_by')
