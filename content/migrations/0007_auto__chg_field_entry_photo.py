...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.photo'
        db.alter_column('content_entry', 'photo', self.gf('django.db.models.fields.URLField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Entry.photo'
        db.alter_column('content_entry', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
