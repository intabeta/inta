...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InterestGroup.posts'
        db.add_column('content_interestgroup', 'posts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InterestGroup.posts'
        db.delete_column('content_interestgroup', 'posts')
