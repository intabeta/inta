...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InterestGroup.members'
        db.add_column('content_interestgroup', 'members',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InterestGroup.members'
        db.delete_column('content_interestgroup', 'members')
