...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.date_added'
        db.alter_column('content_entry', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Entry.date_added'
        db.alter_column('content_entry', 'date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
