...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IgProposal.username'
        db.delete_column('content_igproposal', 'username')

        # Deleting field 'IgProposal.private_group'
        db.delete_column('content_igproposal', 'private_group')


    def backwards(self, orm):
        # Adding field 'IgProposal.username'
        db.add_column('content_igproposal', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IgProposal.private_group'
        db.add_column('content_igproposal', 'private_group',
