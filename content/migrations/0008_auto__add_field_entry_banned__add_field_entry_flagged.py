...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.banned'
        db.add_column('content_entry', 'banned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Entry.flagged'
        db.add_column('content_entry', 'flagged',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.banned'
        db.delete_column('content_entry', 'banned')

        # Deleting field 'Entry.flagged'
        db.delete_column('content_entry', 'flagged')
