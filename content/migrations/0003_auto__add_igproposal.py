...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IgProposal'
        db.create_table('content_igproposal', (
        ...
        db.send_create_signal('content', ['IgProposal'])


    def backwards(self, orm):
        # Deleting model 'IgProposal'
        db.delete_table('content_igproposal')
