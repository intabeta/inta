...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.ig'
        db.add_column('content_entry', 'ig',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['content.InterestGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.ig'
        db.delete_column('content_entry', 'ig_id')
