...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.last_score'
        db.add_column('content_entry', 'last_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Entry.last_growth'
        db.add_column('content_entry', 'last_growth',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.last_score'
        db.delete_column('content_entry', 'last_score')

        # Deleting field 'Entry.last_growth'
        db.delete_column('content_entry', 'last_growth')
    ...
    models = {
        ...
        'content.entry': {
            ...
            'last_growth': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '5', 'decimal_places': '2'}),
