            ...
            if post_slug not in voter and post_slug not in double_voter:
                if action == 'vote':
                    ...
                    for tag in post_change.tags.all():
                        ...
                        post_change.decayed_score_1.tagval_set.get(tag.name=tag.name).val += 1
                        post_change.decayed_score_2.tagval_set.get(tag.name=tag.name).val += 1
                        post_change.decayed_score_3.tagval_set.get(tag.name=tag.name).val += 1
                        post_change.decayed_score_4.tagval_set.get(tag.name=tag.name).val += 1
                        post_change.decayed_score_5.tagval_set.get(tag.name=tag.name).val += 1
                        post_change.decayed_score_6.tagval_set.get(tag.name=tag.name).val += 1
                        post_change.decayed_score_7.tagval_set.get(tag.name=tag.name).val += 1
                        post_change.decayed_score_8.tagval_set.get(tag.name=tag.name).val += 1
                        post_change.save()
