...
class Entry(models.Model):
    ...
    # Decay
    decayed_score_1 = models.DecimalField(max_digits=12, decimal_places=6,  default=0.0) #30 min
    decayed_score_2 = models.DecimalField(max_digits=12, decimal_places=6,  default=0.0) #3 hours
    decayed_score_3 = models.DecimalField(max_digits=12, decimal_places=6,  default=0.0) #1 day
    decayed_score_4 = models.DecimalField(max_digits=12, decimal_places=6,  default=0.0) #3 days
    decayed_score_5 = models.DecimalField(max_digits=12, decimal_places=6,  default=0.0) #7 days
    decayed_score_6 = models.DecimalField(max_digits=12, decimal_places=6,  default=0.0) #1 month
    decayed_score_7 = models.DecimalField(max_digits=12, decimal_places=6,  default=0.0) #3 months
    decayed_score_8 = models.DecimalField(max_digits=12, decimal_places=6,  default=0.0) #1 year
...
class InterestEmail(models.Model):
>>>>>>> added fields for decayed_score_2 through 8
