...
class Entry(models.Model):
    ...
    voted_by = models.ForeignKey(Dict, related_name='+', editable=False, blank=True, null=True, db_constraint=False) #reference a Dict of Voters
    date_added = models.DateTimeField(editable=False, auto_now_add=True)
    posts = models.ForeignKey(Dict, related_name='+', db_constraint=False) #reference a Dict containing tags and associated post counts
    double_posts = models.ForeignKey(Dict, related_name='+', db_constraint=False)
    favorites = models.ForeignKey(Dict, related_name='+', db_constraint=False)
    ...
    # Decay
    decayed_score_1 = models.ForeignKey(Dict, related_name='+', db_constraint=False) #each of these references a Dict which keeps track of decayed scores for each tag
    decayed_score_2 = models.ForeignKey(Dict, related_name='+', db_constraint=False)
    decayed_score_3 = models.ForeignKey(Dict, related_name='+', db_constraint=False)
    decayed_score_4 = models.ForeignKey(Dict, related_name='+', db_constraint=False)
    decayed_score_5 = models.ForeignKey(Dict, related_name='+', db_constraint=False)
    decayed_score_6 = models.ForeignKey(Dict, related_name='+', db_constraint=False)
    decayed_score_7 = models.ForeignKey(Dict, related_name='+', db_constraint=False)
    decayed_score_8 = models.ForeignKey(Dict, related_name='+', db_constraint=False)
