        ...
        ##                action = request.session.get('action','')
                ...
                if post_slug not in voter and post_slug not in double_voter:
                    ...
                    if action == 'vote':
                        ...
                        try:
                            p=post_change.posts.tagval_set.get(tag__iexact=tagnew)
                            p.val += 1
                            p.save()
                        except:
                            post_change.posts.tagval_set.create(tag=tagnew,val=1)
                        tval1=post_change.decayed_score_1.tagval_set.get(tag__iexact=tagnew)
                        tval1.val += 1
                        tval1.save()
                        tval2=post_change.decayed_score_2.tagval_set.get(tag__iexact=tagnew)
                        tval2.val += 1
                        tval2.save()
                        tval3=post_change.decayed_score_3.tagval_set.get(tag__iexact=tagnew)
                        tval3.val += 1
                        tval3.save()
                        tval4=post_change.decayed_score_4.tagval_set.get(tag__iexact=tagnew)
                        tval4.val += 1
                        tval4.save()
                        tval5=post_change.decayed_score_5.tagval_set.get(tag__iexact=tagnew)
                        tval5.val += 1
                        tval5.save()
                        tval6=post_change.decayed_score_6.tagval_set.get(tag__iexact=tagnew)
                        tval6.val += 1
                        tval6.save()
                        tval7=post_change.decayed_score_7.tagval_set.get(tag__iexact=tagnew)
                        tval7.val += 1
                        tval7.save()
                        tval8=post_change.decayed_score_8.tagval_set.get(tag__iexact=tagnew)
                        tval8.val += 1
                        tval8.save()
                    ...
                    if action == 'double_vote':
                        ...
                        try:
                            dbp=post_change.double_posts.tagval_set.get(tag__iexact=tagnew)
                            dbp.val += 1
                            dbp.save()
                        except:
